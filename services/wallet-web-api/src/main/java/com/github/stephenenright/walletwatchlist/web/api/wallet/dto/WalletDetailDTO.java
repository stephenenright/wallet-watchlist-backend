...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Detailed wallet information including balances and recent activity")
public class WalletDetailDTO {
	...
	@Schema(description = "List of assets held in the wallet")
	private List<WalletAssetDTO> assets;

	@Schema(description = "Recent wallet activity (most recent first)")
	private List<WalletActivityDTO> recentActivity;
}
